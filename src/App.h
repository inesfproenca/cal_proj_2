...
public:
	 ...
	 * @returns whether or not offer and request are compatible
	 */
	bool matchRides(RideOffer &offer, RideRequest &request);

	/**
	 * Tries to match a new ride with compatible ones (offers with requests)
	 * @param newRide new ride inserted in application
	 * @returns whether or not match was found
	 */
	bool tryToMatchRide(Ride* newRide);
	...
	/**
	 * Shows All Offers Information
	 */
	void showOffersInfo();

	/**
	 * Shows All Requests Information
	 */
	void showRequestsInfo();

	/**
	 * Shows All Users and Offers Information
	 */
	void showAllInfo();
