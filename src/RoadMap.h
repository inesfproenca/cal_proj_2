 ...
 */
class RoadMap : protected Graph<Crossroad, Road> {
private:
...
public:
	...
	/**
	 * @param path list of crossroad ids of given path
	 * @returns the name of the roads passed in certain path
	 */
	vector<string> getRoadsPassed(list<uint> path);
